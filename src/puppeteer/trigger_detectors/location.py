    ...
    def trigger_probabilities(
        ...
        for loc in locs_list:
            ...
            if is_specific:
                ...
                pass
        if len(locs_list) == 0 and non_event_prob > 0.9:
            ...
            if len(locs_list) < 3:
                non_event_prob = 0.3
                max_confidence_we_saw_a_loc_statement = 0.7
...
class CityInExtractionsTriggerDetector(TriggerDetector):
    ...
    def trigger_probabilities(
        ...
        if not (
            old_extractions.has_extraction("first_name")
            and old_extractions.has_extraction("last_name")
        ):
            return ({}, 1.0, Extractions())
